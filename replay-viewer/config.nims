...
switch(
  "passL",
  (&"""
  -o {distDir / "gridwars_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=GridWarsReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_gw_load_replay,_gw_payload_ptr,_gw_payload_len,_gw_error_ptr,_gw_error_len
  """).replace("\n", " ")
)
